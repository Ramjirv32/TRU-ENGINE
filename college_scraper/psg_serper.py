...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
        ...
        for future in concurrent.futures.as_completed(futures):
            ...
            try:
                ...
                parse_error = None
                if markdown:
                    parsed, parse_error = extract_json_from_markdown(markdown)
                
                if college_name not in results["colleges"]:
                    results["colleges"][college_name] = {"queries": {}, "total_time": 0}
                
                results["colleges"][college_name]["queries"][query_type] = {
    ...
    output_file = "/home/ramji/Videos/scap/college_scraper/psg_college_of_tech_serper.json"
